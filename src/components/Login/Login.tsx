...
const Login: React.FC<LoginModalProps> = ({ loginOpen, onLoginChange }) => {
  ...
  const [authMode, setAuthMode] = useState<"login" | "signup" | "forgot-password" | "verify-email">("login");
        ...
        >
          ...
          >
            ...
            <div className="flex items-center justify-between">
                <button className="text-sm text-red-600 hover:text-red-700 hover:underline" onClick={()=> setAuthMode("forgot-password")}>
                  Forgot password?
                </button>
              </div>
