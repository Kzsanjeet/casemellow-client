...
// const fetchCartDetails = async () => {
//   if (!clientId) return; // Ensure valid clientId before fetching
//   setLoading(true);
//   try {
//     const fetchData = await fetch(`${process.env.NEXT_PUBLIC_LOCAL_PORT}/cart/get/${clientId}`, {
//       method: 'GET',
...
// useEffect(() => {
//   if (clientId) {
//     fetchCartDetails(); // Refactor to avoid unnecessary re-fetches
//   }
// }, [clientId]); // Refetch when `clientId` changes
