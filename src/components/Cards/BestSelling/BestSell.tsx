...
const BestSell = () => {
  return (
    ...
    <div className="text-center mb-6 md:mb-8 mt-8">
     <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold text-black mb-2 sm:mb-4">Best selling products</h1>
     <div className='bg-red-500 h-1'></div>
     <p className="text-xl sm:text-xl font-medium text-gray-700">Shop from our best selling phone cases</p>
   </div>
