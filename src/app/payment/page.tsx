            ...
            <div className="bg-white rounded-lg shadow-sm p-6">
              ...
              <div className="pt-4 border-t border-gray-200">
                <div className="flex justify-between items-center mb-6">
                  ...
                  <span className="text-lg font-semibold text-orange-500">Rs. {total}</span>
                </div>
                
                <button disabled={!selectedMethod} onClick={handlePayment} className="w-full bg-blue-600 hover:bg-blue-700 text-white rounded-lg py-3 font-medium transition-colors">
                  Proceed to Pay
                </button>
