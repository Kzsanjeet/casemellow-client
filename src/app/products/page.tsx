...
//       <Nav />
//       <div className="flex-1 pt-20 container mx-auto w-[80%]">
...
//           </div>
//           <div className="max-w-xs sm:max-w-sm md:max-w-md lg:max-w-lg xl:max-w-xl 2xl:max-w-2xl mx-auto pb-4 flex justify-between">
...
//             } md:block md:w-1/5 sticky top-24 self-start max-h-[calc(100vh-120px)] overflow-y-auto pr-4`}
//           >
